...
export default function SyncActivity() {
  ...
  return (
    <main className="flex-1 flex flex-col overflow-hidden">
      <PageHeader>
        <h1 className="text-lg font-bold text-base-content leading-tight">Sync Activity</h1>
        <p className="text-xs text-base-content/40 leading-tight">Live Feed Of Sync Events</p>
      </PageHeader>
