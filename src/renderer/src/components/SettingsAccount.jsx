  ...
  return (
    <SettingsCard label="Account">
      <button
        type="button"
        onClick={onClick}
        className="w-full flex items-center gap-4 px-5 pt-3 pb-4 hover:bg-gray-50 hover:cursor-pointer transition-colors text-left focus-visible:outline focus-visible:outline-offset-2 focus-visible:outline-[#8B1A1A]"
      >
